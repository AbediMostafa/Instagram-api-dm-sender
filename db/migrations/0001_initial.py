# Generated by Django 5.1.3 on 2025-08-24 17:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("spintax", models.TextField(blank=True, null=True)),
                (
                    "category",
                    models.ForeignKey(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "state",
                    models.CharField(
                        choices=[("fr", "Free"), ("fl", "Followed"), ("p", "Pending")],
        ...
        migrations.AddField(
            model_name="dmpost",
            name="leads",
            field=models.ManyToManyField(through="db.DmPostLead", to="db.lead"),
        ),
        migrations.AddField(
            model_name="profile",
            name="proxy",
